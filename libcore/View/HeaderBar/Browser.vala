...
public class Browser : Object {
    private BrowserStack<string> back_stack;
    private BrowserStack<string> forward_stack;

    private string current_uri = null;
    private int history_list_length = 10; // Number of items to show in browser button menu

    construct {
        back_stack = new BrowserStack<string> ();
        forward_stack = new BrowserStack<string> ();
    }

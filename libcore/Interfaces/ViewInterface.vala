...
//                 // if (current_drop_uri == null || current_drop_uri != fileitem) {
//                     // if (current_drop_uri != null) {
//                     //     current_drop_uri.reveal_drop_target (false);
//                     // }
...
//                     );
//             // }
//                     // if (current_drop_uri.drop_target_revealed ()) {
//                     //     if (dragged_row != null) {
//                     //         move_item_after (dragged_row, current_drop_uri.get_index ());
//                     //     } else {
//                     //         var index = 1;
//                     //         //TODO Limit list length to sensible value?
//                     //         foreach (var file in dropped_files) {
//                     //             add_favorite (file.get_uri (), "", current_drop_uri.get_index () + index++);
//                     //         }
//                     //     }
//                     // } else {
//                     //     if (dragged_row != null) {
...
//                     //             this,
//                     //             x, y,
//                     //             Files.File.@get (File.new_for_uri (current_drop_uri.uri)),
//                     //             dropped_files,
//                     //             Gdk.DragAction.COPY | Gdk.DragAction.MOVE | Gdk.DragAction.LINK,
//                     //             Gdk.DragAction.COPY,
//                     //             true

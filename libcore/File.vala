...
public class GOF.File : GLib.Object {
    ...
    public void update () {
        ...
        is_web_link = PF.FileUtils.is_web_link (this, null);
        if (is_web_link)  {
            custom_icon_name = "applications-internet";
        }
    ...
    public void update_emblem () {
        ...
        if (!is_writable () && !is_recent_uri_scheme () && !is_web_link) {
            if (is_readable ()) {

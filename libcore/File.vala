...
public class GOF.File : GLib.Object {
    ...
    public void update () {
        ...
        if (custom_display_name == null && info != null) {
            ...
            } else if (target_location != null && directory != null && directory.has_uri_scheme ("recent")) {
                custom_display_name = PF.FileUtils.limited_length_path (target_location.get_path (), 50);
            } else {

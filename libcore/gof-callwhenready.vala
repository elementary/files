...
public class GOF.CallWhenReady : Object {
    ...
    private unowned string gio_default_attributes = "standard::is-hidden,standard::is-backup,standard::is-symlink,standard::type,standard::name," +
    "standard:: display-name,standard::fast-content-type,standard::size,standard::symlink-target," +
    "access::*,time::*,owner::*,trash::*,unix::*,id::filesystem,thumbnail::*";

...
public abstract class Sidebar.BasicAbstractMountableRow : Sidebar.BasicBookmarkRow, SidebarItemInterface {
    ...
    protected BasicAbstractMountableRow (string name, string uri, Icon gicon, SidebarListInterface list,

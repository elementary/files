...
public class Sidebar.BasicDriveRow : Sidebar.BasicAbstractMountableRow, SidebarItemInterface {
    ...
    public BasicDriveRow (string name, string uri, Icon gicon, SidebarListInterface list,

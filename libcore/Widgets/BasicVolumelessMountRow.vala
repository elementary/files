...
public class Sidebar.BasicVolumelessMountRow : Sidebar.BasicAbstractMountableRow, SidebarItemInterface {
    public BasicVolumelessMountRow (string name, string uri, Icon gicon, SidebarListInterface list,

...
public class Sidebar.BasicVolumeRow : Sidebar.BasicAbstractMountableRow, SidebarItemInterface {
    ...
    public BasicVolumeRow (string name, string uri, Icon gicon, SidebarListInterface list,

...
update_places (MarlinPlacesSidebar *sidebar)
{
    ...
    gtk_tree_store_set (sidebar->store, &iter,
                        ...
                        PLACES_SIDEBAR_COLUMN_TOOLTIP, _("Personal bookmarked places"),
                        -1);
                      ...
                      GtkTreePath **path)
{
    ...
    *path = NULL;
    ...
    if ((event->type == GDK_BUTTON_PRESS || event->type == GDK_BUTTON_RELEASE) &&
        ...
        //TODO check this
        total_width += EJECT_BUTTON_XPAD + TEXT_XPAD;
                        ...
                        gpointer user_data)
{
    //amtest
    printf ("%s\n", G_STRFUNC);
    /*open_selected_bookmark (MARLIN_PLACES_SIDEBAR (user_data),
...
static void
open_shortcut_from_menu (MarlinPlacesSidebar *sidebar,
                         MarlinViewWindowOpenFlags	       flags)
{
    GtkTreeModel *model;
    GtkTreePath *path;

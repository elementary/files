...
static void     eel_editable_label_cell_editable_init      (GtkCellEditableIface  *iface);
...
static void     eel_editable_label_start_editing (GtkCellEditable *cell_editable,
                                                  GdkEvent *event);
...
G_DEFINE_TYPE_WITH_CODE (EelEditableLabel, eel_editable_label, GTK_TYPE_MISC,
             ...
             G_IMPLEMENT_INTERFACE (GTK_TYPE_CELL_EDITABLE,
                                    eel_editable_label_cell_editable_init));
...
static void
eel_editable_label_cell_editable_init (GtkCellEditableIface *iface)
{
  iface->start_editing = eel_editable_label_start_editing;
}
				 ...
				 GParamSpec  *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_SELECTION_BOUND:
      ...
      break;
    case PROP_EDITING_CANCELED:
      g_value_set_boolean (value, label->editing_canceled);
      break;
...
static gboolean
gtk_cell_editable_key_press_event (EelEditableLabel *label,

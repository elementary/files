        ...
        protected virtual bool on_view_key_press_event (Gdk.EventKey event) {
            ...
            switch (keyval) {
                ...
                case Gdk.Key.Right:
                    ...
                    res = move_cursor (keyval, only_shift_pressed, only_control_pressed);
...
/** Abstract methods - must be overridden*/
        ...
        protected virtual bool move_cursor (uint keyval, bool only_shift_pressed, bool on_control_pressed) {
            return false;
        }

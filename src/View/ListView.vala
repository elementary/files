...
namespace FM {
    public class ListView : AbstractTreeView {
        ...
        private void append_extra_tree_columns () {
            ...
            int preferred_column_width = app.marlin_column_view_settings.get_int ("preferred-column-width");
        ...
        protected override Marlin.ZoomLevel get_set_up_zoom_level () {
            var zoom = app.marlin_list_view_settings.get_enum ("zoom-level");
            app.marlin_list_view_settings.bind ("zoom-level", this, "zoom-level", GLib.SettingsBindFlags.SET);

            minimum_zoom = (Marlin.ZoomLevel)app.marlin_list_view_settings.get_enum ("minimum-zoom-level");
            maximum_zoom = (Marlin.ZoomLevel)app.marlin_list_view_settings.get_enum ("maximum-zoom-level");
        ...
        public override Marlin.ZoomLevel get_normal_zoom_level () {
            var zoom = app.marlin_list_view_settings.get_enum ("default-zoom-level");
            app.marlin_list_view_settings.set_enum ("zoom-level", zoom);

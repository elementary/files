...
public class Files.View.Window : Hdy.ApplicationWindow {
    ...
    private void build_window () {
        ...
        view_switcher.action.activate.connect ((id) => {
            switch ((ViewMode)(id.get_uint32 ())) {
                case ViewMode.ICON:
                    app_menu.on_zoom_setting_changed (icon_view_settings, "zoom-level");
                    break;
                case ViewMode.LIST:
                    app_menu.on_zoom_setting_changed (list_view_settings, "zoom-level");
                    break;
                case ViewMode.MILLER_COLUMNS:
                    app_menu.on_zoom_setting_changed (column_view_settings, "zoom-level");
                    break;
    ...
    public void change_state_show_hidden (GLib.SimpleAction action) {
        ...
        new Settings ("io.elementary.files.preferences").set_boolean (
            "show-hiddenfiles", state
        );
    }
    ...
    private ViewMode real_mode (ViewMode mode) {
        ...
        return new Settings ("io.elementary.files.preferences").get_enum (
            "default-viewmode"
        );
    }
    ...
    private void save_active_tab_position () {
        ...
        new Settings ("io.elementary.files.preferences").set_int (
            "active-tab-position",
    ...
    private void update_headerbar () {
        ...
        new Settings ("io.elementary.files.preferences").set_enum (
            "default-viewmode", mode
        );
    }

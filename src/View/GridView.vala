...
namespace Files {
    public class GridView : AbstractDirectoryView {
        ...
        ~GridView () {
            debug ("Grid View destruct");
        }

        construct {
            list_model = new ListStore (typeof (Files.File));
            item_factory = new Gtk.SignalListItemFactory ();
            multiselection = new Gtk.MultiSelection (list_model);
        ...
        //                                  bool select,
        //                                  bool scroll_to_top) {
        // public override void set_view_cursor (Files.File file,
        //                                  bool start_editing,
        //                                  bool select,
        //                                  bool scroll_to_top) {
            // if (path == null) {
    ...
    // public class GridViewItemFactory : Gtk.ListItemFactory {

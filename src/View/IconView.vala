...
namespace FM {
    public class IconView : AbstractDirectoryView {
        ...
        protected override Marlin.ZoomLevel get_set_up_zoom_level () {
            var zoom = app.marlin_icon_view_settings.get_enum ("zoom-level");
            app.marlin_icon_view_settings.bind ("zoom-level", this, "zoom-level", GLib.SettingsBindFlags.SET);

            minimum_zoom = (Marlin.ZoomLevel)app.marlin_icon_view_settings.get_enum ("minimum-zoom-level");
            maximum_zoom = (Marlin.ZoomLevel)app.marlin_icon_view_settings.get_enum ("maximum-zoom-level");
        ...
        public override Marlin.ZoomLevel get_normal_zoom_level () {
            var zoom = app.marlin_icon_view_settings.get_enum ("default-zoom-level");
            app.marlin_icon_view_settings.set_enum ("zoom-level", zoom);

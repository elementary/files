    ...
    public class BreadcrumbIconList : Object {
        ...
        public BreadcrumbIconList (Gtk.StyleContext _context) {
            ...
            if (dir.contains (Path.DIR_SEPARATOR_S)) {
                BreadcrumbIconInfo icon = {dir, Marlin.ICON_FOLDER_MUSIC_SYMBOLIC, false, null, null, dir.split (Path.DIR_SEPARATOR_S), false, null};
            ...
            if (dir.contains (Path.DIR_SEPARATOR_S)) {
                BreadcrumbIconInfo icon = {dir, Marlin.ICON_FOLDER_PICTURES_SYMBOLIC, false, null, null, dir.split (Path.DIR_SEPARATOR_S), false, null};
                icon.exploded[0] = Path.DIR_SEPARATOR_S;
                add_icon (icon);
            }
            ...
            if (dir.contains (Path.DIR_SEPARATOR_S)) {
                BreadcrumbIconInfo icon = {dir, Marlin.ICON_FOLDER_VIDEOS_SYMBOLIC, false, null, null, dir.split (Path.DIR_SEPARATOR_S), false, null};
                icon.exploded[0] = Path.DIR_SEPARATOR_S;
                add_icon (icon);
            }
            ...
            if (dir.contains (Path.DIR_SEPARATOR_S)) {
                BreadcrumbIconInfo icon = {dir, Marlin.ICON_FOLDER_DOWNLOADS_SYMBOLIC, false, null, null, dir.split (Path.DIR_SEPARATOR_S), false, null};
                icon.exploded[0] = Path.DIR_SEPARATOR_S;
                add_icon (icon);
            }
            ...
            if (dir.contains (Path.DIR_SEPARATOR_S)) {
                BreadcrumbIconInfo icon = {dir, Marlin.ICON_FOLDER_DOCUMENTS_SYMBOLIC, false, null, null, dir.split (Path.DIR_SEPARATOR_S), false, null};
                icon.exploded[0] = Path.DIR_SEPARATOR_S;
                add_icon (icon);
            }
            ...
            if (dir.contains (Path.DIR_SEPARATOR_S)) {
                BreadcrumbIconInfo icon = {dir, Marlin.ICON_FOLDER_TEMPLATES_SYMBOLIC, false, null, null, dir.split (Path.DIR_SEPARATOR_S), false, null};
                icon.exploded[0] = Path.DIR_SEPARATOR_S;
                add_icon (icon);
            }
